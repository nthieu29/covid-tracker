...
Live demo: https://master.d17fr9nv7izdex.amplifyapp.com/

## Features
* Simple and elegant user interface.
* Quickly to find and select a country with autocomplete.
* Include a Graph using [recharts](https://recharts.org/en-US/).
* Created with [Create react app](https://github.com/facebook/create-react-app).
* Built with [Material-UI](https://material-ui.com/).
# ![Build your own data structure](images/screenshot1.png)
